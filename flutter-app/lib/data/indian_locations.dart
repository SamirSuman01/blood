/// Indian States, Union Territories, and Districts data
/// Organized hierarchically for location selection
...
class IndianLocations {
  static const Map<String, Map<String, dynamic>> locations = {
    ...
    'Arunachal Pradesh': {
      ...
      'districts': [
        ...
        'Tirap', 'Longding', 'Lohit', 'Anjaw', 'Dibang Valley', 'Lower Dibang Valley'
      ]
    },
    'Assam': {
      'code': 'AS',
  ...
  /// Get districts for a given state/UT
  static List<String> getDistricts(String state) {
    return (locations[state]?['districts'] as List<String>?) ?? [];
  }

  /// Get state code
  static String getStateCode(String state) {
    return locations[state]?['code'] ?? '';
  }

  /// Get type (State or UT)
  static String getType(String state) {
    return locations[state]?['type'] ?? '';
  }
}
